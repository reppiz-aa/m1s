...
VERSION="4.1.4_0012.0650_mi_4.0.6_0001"
COOR_MD5SUM="86ab3ace5e29f335d4b38a5b9314d88f"
KERNEL_MD5SUM="2234fdb60dbcd78b23b9c9bad5004a83"
ROOTFS_MD5SUM="8589d15a08a94ecc74d950b2b110cfdd"
MODIFIED_ROOTFS_MD5SUM="619d526b638963ef9beb5c26bc2c4395"
BTBL_MD5SUM=""
BTAPP_MD5SUM=""
IRCTRL_MD5SUM=""
...
initial()
{
    ...
    if [ "$product" != "lumi.gateway.aeu01" ]; then
